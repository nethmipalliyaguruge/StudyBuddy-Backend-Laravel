<div class="card">
    ...
    <div class="p-4">
        ...
        <form wire:submit="create" class="flex flex-wrap gap-2 mb-6">
            <select wire:model="schoolId" class="select w-auto">
        ...
        <div class="space-y-2">
            @forelse($levels as $level)
                <div wire:key="level-{{ $level->id }}" class="p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-sm text-gray-500 ml-2">
                                    ({{ $level->school->name ?? 'Unknown' }} &bull; {{ $level->modules_count }} modules)
                                </span>
                            </div>
                            <div class="flex items-center gap-3">
                                <button
                                    type="button"
                                    wire:click="startEdit({{ $level->id }})"
            ...
            @empty
                <p class="text-gray-500 text-center py-4">No levels found. Add one above.</p>
            @endforelse
        </div>
    </div>
</div>
